...
const About = () => {
  ...
  return (
    <section
      id="about"
      ref={sectionRef}
      className="relative w-full min-h-screen bg-cream overflow-hidden flex items-center z-10 py-20 lg:py-0"
    >
      ...
      <div className="max-w-[1200px] w-full mx-auto px-6 md:px-12 lg:pl-32 relative z-10 flex flex-col lg:flex-row h-full">

        {/* LEFT SECTION (48% Width to make image larger) */}
        <motion.div
          className="w-full lg:w-[48%] relative flex items-start mt-8 lg:mt-16 justify-end lg:pr-8"
        ...
        <motion.div
          className="w-full lg:w-[52%] flex flex-col justify-start lg:pt-16 relative z-20 mt-8 lg:mt-0"
        ...
        >
          ...
          <motion.div variants={fadeUp} className="mb-6">
            ...
            <h2 className="font-playfair text-[3.5rem] md:text-6xl lg:text-[5.5rem] text-dark-red font-bold leading-[0.9] tracking-tighter">
              ANKITA<br />KARAN
            </h2>
          </motion.div>
          ...
          {/* Paragraph */}
          <motion.div variants={fadeUp} className="mb-10 max-w-[500px]">
            <p className="font-inter text-sm text-dark-brown/80 leading-[1.8]">
          ...
          <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4 mb-10">
            <a href="/Ankita_Karan_Resume.pdf" target="_blank" rel="noreferrer" className="btn-filled">
              <Download size={16} />
              DOWNLOAD RESUME
            </a>
          </motion.div>
